...
export function createCtx<StateType, ActionType>(
  ...
  const Provider = (props: React.PropsWithChildren<{}>) => {
    ...
    return <ctx.Provider value={{ state, dispatch, enhanceDispatch }} {...props} />
  }
  return [ctx, Provider] as const
}
const [MathExpressionContext, MathExpressionContextProvider] = createCtx(mathExpressionReducer, initMathExpression)
// export const MathExpressionContext = ctx
// const MathExpressionContext = createContext({})

// const MathExpressionContextProvider = ({ children }) => {
...
//   console.log(`*****************`)
//   console.log(state)
//   const enhanceDispatch = applyMiddleware(state, dispatch)
//   return (
//     <MathExpressionContext.Provider
//       value={{ state, dispatch, enhanceDispatch }}
//     >
//       {children}
//     </MathExpressionContext.Provider>
//   )
