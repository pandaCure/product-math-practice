...
const submit_button_png_1 = __importDefault(
  require('../asserts/submit-button.png')
)
const enhance_mathquill_edit_1 = __importDefault(
...
const PrimaryKeyBoard = () => {
  ...
  const { dispatch, enhanceDispatch, state, prefixCls } = react_1.useContext(
    mathExpressionContext_1.MathExpressionContext
  )
