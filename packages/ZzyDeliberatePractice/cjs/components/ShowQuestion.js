...
var ShowQuestion = function () {
    ...
    var _b = state.addition, addMathExpression = _b.addMathExpression, currentDoProblemId = _b.currentDoProblemId;
    ...
    return (react_1.default.createElement("div", { className: prefixCls + "-show-question" },
        react_1.default.createElement("div", { className: prefixCls + "-question-block" },
            react_1.default.createElement("ul", { className: prefixCls + "-question-view", ref: uiDOM }, addMathExpression.map(function (v, i) {
